...
const gRandomInt = (min: number, max: number) =>
...
const generateFakePlayer = (i: number): PlayerData => {
  ...
  return {
    ...
    hp: gRandomInt(0, 100),
    isCurrentlyObserved: gRandomInt(0, 5) > 4,
    creditsHistory: [],
    ultHistory: [],
    loadoutKills: {},
    killRoundHistory: [],
    diedAtRound: {},
    lastLoadout: randomWeapon,
    scoreboard: {
      ...
      weapon: randomWeapon,
      lastOCRIteration: 0,
      armor: (["heavy", "light", "regen", "none"] as const)[gRandomInt(0, 3)],
    },
    observed: {
      username: `Player #${i}`,
      agent: "Viper",
          ...
          if (USE_TEST_DATA) {
            const fakeValorantData: ValorantRaw = {
              ...
              right: {
                ...
                players: new Array(5)
                  .fill(0)
                  .map((_, i) => generateFakePlayer(i + 5)),
                roundHistory: [],
              },
            };
